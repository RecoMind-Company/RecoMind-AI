...
class TestTimeEstimatorService:
    ...
    def test_estimate_multiple_tasks(self, mock_employees):
        ...
        tasks = [
            Task(task_id="t1", title="كتابة", description="", required_skill="Content Writing"),
            Task(task_id="t2", title="تصميم", description="", required_skill="Design"),
            Task(task_id="t3", title="نشر", description="", required_skill="Social Media"),
        ]
