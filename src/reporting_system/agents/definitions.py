"""CrewAI agent definitions for data collection and SQL generation."""
...
def create_retrieval_agent() -> Agent:
    """Creates the Database Context Retrieval Agent."""
    return Agent(
...
def create_table_analyzer_agent() -> Agent:
    """Creates the Database Context Analyzer Agent."""
    return Agent(
        ...
        backstory=(
            ...
            "**ERROR HANDLING:** If the input text says 'error' or 'No tables found', you MUST output exact JSON: `{\"selected_tables\": [\"ERROR_NO_TABLES\"], \"key_info\": {}}`.\n"
...
def create_schema_retriever_agent() -> Agent:
    """Creates the Schema Retrieval Bot Agent."""
    return Agent(
...
def create_column_selector_agent() -> Agent:
    """Creates the Column Selector and Data Planner Agent."""
    return Agent(
...
def create_query_generator_agent() -> Agent:
    """Creates the SQL Query Assembler Agent."""
    return Agent(
...
def create_all_agents() -> List[Agent]:
    """Creates fresh instances of all 5 data collection agents."""
    return [
